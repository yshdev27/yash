  ...
  return (
    <li>
      ...
      >
        {children}
        {isActive && (
          <span className="absolute inset-x-1 -bottom-px h-px bg-linear-to-r from-blue-500/0 via-sky-500/40 to-sky-500/0 dark:from-blue-400/0 dark:via-blue-400/40 dark:to-teal-400/0" />
        )}
      </Link>
    </li>
  )
