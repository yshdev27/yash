...
export const article = {
  ...
  description:
    "When you’re building a website for a company as ambitious as Google, you need to make an impression. I wanted people to visit our website and see animations that looked more realistic than reality itself.",
};
